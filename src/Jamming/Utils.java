...
public class Utils {
    ...
    static final int NumberOfClient = 50;
    static double MaximumClientSpeed = 7;

    static final double FirstSimulationJammerTxPower = 20;
    static final double SecondSimulationJammerTxPower = 30;
    ...
    static double Client_Sense_Noise_Figure = 2;
