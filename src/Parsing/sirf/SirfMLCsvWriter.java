        ...
        for (Integer PRN : meas.getSatellites().keySet()){
            ...
            //for (Integer PRN : meas.getSatellites().keySet()){
                ...
                else
                {
                    ...
                    res += sv.getDeltaCorrectedPrNovelocityShift()+",";
